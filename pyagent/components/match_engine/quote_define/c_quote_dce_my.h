#ifndef C_QUOTE_DCE_MY_H
#define C_QUOTE_DCE_MY_H
...
//    UINT4 AskImplyQty;                    //申卖推导量
    ...
    char LocalDate[9];                   //本地日期
};

////////////////////////////////////////////////
///MDBestAndDeep：arbi深度行情
////////////////////////////////////////////////
struct dce_my_best_deep_arbi_quote
{
    char Type;
    unsigned int Length;                         //报文长度
    unsigned int Version;                        //版本从1开始
